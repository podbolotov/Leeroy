...
Книги могут быть добавлены администраторами и просмотрены любыми пользователями единым списком.
